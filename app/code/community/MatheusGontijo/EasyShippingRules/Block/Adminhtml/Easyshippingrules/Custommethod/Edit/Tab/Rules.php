...
/**
 * Adminhtml Easy Shipping Rules Custom Methods Edit Tab Rules block
 *
 ...
 * @license     OSL v3.0
 */
class MatheusGontijo_EasyShippingRules_Block_Adminhtml_Easyshippingrules_Custommethod_Edit_Tab_Rules
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        if ($this->_getCustomMethod()->getLinkRuleIds()) {
     ...
     * @param object $column
     *
     * @return MatheusGontijo_EasyShippingRules_Block_Adminhtml_Easyshippingrules_Custommethod_Edit_Tab_Rules
     */
     ...
     *
     * @return MatheusGontijo_EasyShippingRules_Model_Custommethod
     */
    protected function _getCustomMethod()
    {
        return Mage::registry('current_easyshippingrules_custom_method');
    }
    ...
    protected function _getSelectedRules()
    {
        ...
        if (!is_array($rules)) {
            $rules = $this->_getCustomMethod()->getLinkRuleIds();
        }
